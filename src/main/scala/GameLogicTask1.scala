...
class GameLogicTask1(SpriteNumber: Int, BackTileNumber: Int, TuneNumber: Int) extends Module {
  ...
  // Add stationary sprite 1
  io.spriteVisible(1) := true.B
  io.spriteXPosition(1) := 50.S
  io.spriteYPosition(1) := 360.S

  // Add stationary sprite 2
  io.spriteVisible(2) := true.B
  io.spriteXPosition(2) := 100.S
  io.spriteYPosition(2) := 300.S
